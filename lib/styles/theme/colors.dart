...
class AppColors {
  ...
  // static const Color brand = const Color(0xff5CDB95);
  static const Color brand = const Color(0xff53D3FF);
  static const Color brandLight = const Color(0xffa6e8ff);
  static const Color brandDark = const Color(0xff06a1d6);
  static const Color brandFont = const Color(0xff05386B);
  static const Color errorWorning = const Color(0xffFF0000);
}
